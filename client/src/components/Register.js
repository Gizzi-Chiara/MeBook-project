            ...
            <div className="register">
                <form onSubmit={register} className="form_register">
                    ...
                    <div>
                        ...
                        {errors.firstName ? <span className="error_register">{errors.firstName.message}</span> : null}
                    </div>
                    <div>
                        ...
                        {errors.email ? <span className="error_register">{errors.email.message}</span> : null}
                    </div>
                    <div>
                        ...
                        {errors.password ? <span className="error_register">{errors.password.message}</span> : null}
                    </div>
                    <div>
                        ...
                        {errors.confirmPassword ? <span className="error_register">{errors.confirmPassword.message}</span> : null}
                    </div>
                    <div>
                        ...
                        {errors.favorite ? <span className="error_register">{errors.favorite.message}</span> : null}
                    </div>
                    <div>
                        ...
                        {errors.birthday ? <span className="error_register">{errors.birthday.message}</span> : null}
                    </div>
                    <input type="submit" value="Register" className="button_reg"/>
                </form>
            </div>
        </div>
    )
